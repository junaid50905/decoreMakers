...
const Checkout = () => {
    ...
    const subTotal = useSelector(state=> state.cartInfo.subTotal)
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-5 mb-md-0">
                            ...
                            <div className="p-3 p-lg-5 border bg-white">
                                ...
                                <div className="form-group row">
                                    <div className="col-md-6">
                                        <label className="text-black">State / Country <span className="text-danger">*</span></label>
                                ...
                                <div className="form-group row mb-5">
                                    ...
                                    <div className="col-md-6">
                                        <label className="text-black">Phone <span className="text-danger">*</span></label>
                                        <input type="text" className="form-control" id="c_phone" name="c_phone" placeholder="Phone Number" />
                                    </div>
                                </div>

                                <div className="form-group">
                                    <label className="text-black" data-bs-toggle="collapse" href="#create_an_account" role="button" aria-expanded="false" aria-controls="create_an_account">
                                ...
                                <div className="form-group">
                                    <label className="text-black" data-bs-toggle="collapse" href="#ship_different_address" role="button" aria-expanded="false" aria-controls="ship_different_address">
                                    ...
                                    <div className="collapse" id="ship_different_address">
                                        <div className="py-2">
                                            ...
                                            <div className="form-group">
                                                <label className="text-black">Country <span className="text-danger">*</span></label>
                                            ...
                                            <tbody>                                                
                                                {
                                                    cartItems.map((cartItem, i)=>{
                                                        const {name, image, quantity, currentPrice} = cartItem
                                                        return(
                                                            <tr key={i}>
                                                                <td>
                                                                ...
                                                                <td>                                
                                                                    ...
                                                                    <strong> ${currentPrice} X {quantity}</strong>
                                                                </td>
                                                                <td>
                                                                    <strong> ${(currentPrice * quantity).toFixed(2)}</strong>
                                                                </td>
                                                            </tr>
                                                        )
                                                    })
